...
beta         = 0.00593 #Need To Paramatize 
...
if scenario == 'Scenario_1_Normal':
    h_beta_changes = [0.90, 0.80, 0.90, 0.80, 0.90, 0.80, 0.90, 0.80, 0.90, 0.80, 0.90, 0.80, 0.90, 0.80]
    s_beta_changes = [0.90, 0.80, 0.90, 0.80, 0.90, 0.80, 0.90, 0.80, 0.90, 0.80, 0.90, 0.80, 0.90, 0.80]
    w_beta_changes = [0.90, 0.80, 0.90, 0.80, 0.90, 0.80, 0.90, 0.80, 0.90, 0.80, 0.90, 0.80, 0.90, 0.80]
    c_beta_changes = [0.90, 0.80, 0.90, 0.80, 0.90, 0.80, 0.90, 0.80, 0.90, 0.80, 0.90, 0.80, 0.90, 0.80]
